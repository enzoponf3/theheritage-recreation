    ...
    <>
      ...
      <div className={styles.features}>
        <div className={styles.selectors}>
          <h4 className={enabled ? "" : styles.disabled} onClick={ () => setEnabled(true)}>Features</h4>
          <h4 className={!enabled ? "" : styles.disabled} onClick={ () => setEnabled(false)}>Close To</h4>
        </div>
        <div className={ enabled ? styles.columns : `${styles.columns} ${styles.disabled}`}>
      ...
      <article>
        ...
        <section>
          ...
          <p>Ranked as an America's Best 50 Cities To Live, Andover is lauded for its outstanding public schools, home value, and quality of life. You couldn't ask for a better place to cultivate your business.
      ...
      <article>
        <div className={styles.residentialImage}>
          <div className={`${styles.articleImage2} ${styles.articleImage}`}></div>
          <div className={`${styles.articleIntro} ${styles.introResidential}`}>
            <div className={styles.pattern1}></div>
            <div className={styles.introContent}>
              <h5>Residential</h5>
              <section>
                <h4><em>Live and connect</em> at <br /> The Heritage.</h4>
